...
def wizard_form_body():
    ...
    if st.session_state['current_step'] == 2:
        st.markdown('\n')
        st.markdown('\n')
        income = st.number_input('Type your monthly income', value = income, on_change = update_income)        
    ...
    if st.session_state['current_step'] == 3:
        ...
        month_options = st.selectbox('Month of credit solicitude:', options = months , index = 0, on_change = update_month)
    ...
    if st.session_state['current_step'] == 4:
        st.markdown('\n')
        st.markdown('\n')                           
        num_bank_accounts = st.number_input('Type the number of distinct bank accounts that you have:')     

    ###### Step 5: Credit Cards ######
    if st.session_state['current_step'] == 5:
        st.markdown('\n')
        st.markdown('\n')                                
        num_credit_card = st.number_input('Type the number of distinct credit cards that you have:')                

    ###### Step 6: Interest Rate ######
    if st.session_state['current_step'] == 6:
        st.markdown('\n')
        st.markdown('\n')                          
        last_interest_rate = st.number_input('Type the last interest rate that you paid:')                             
    ...
    if st.session_state['current_step'] == 8:
        st.markdown('\n')
        st.markdown('\n')                             
        month_delay = st.number_input('Type the maximum month delay you have had from payment due date:')                

    ###### Step 9: Maximum payments delay ######
    if st.session_state['current_step'] == 9:
        st.markdown('\n')
        st.markdown('\n')                            
        payments_delay = st.number_input('Type the maximum payments delay you have had:')                
    ...
    if st.session_state['current_step'] == 10:
        ...
        credit_mix_selection = st.selectbox('What is your credit mix status?',options=credit_mix_options,index=0)
    ...
    if st.session_state['current_step'] == 11:
        st.markdown('\n')
        st.markdown('\n')                               
        Credit_History_Age = st.number_input('Type the number of years you have had a credit history:')     
    ...
    with form_footer_container.container():
        ...
        file_ready = False if st.session_state['current_step'] == 12 is not None else True
