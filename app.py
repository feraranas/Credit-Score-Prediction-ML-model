...
def update_displayName():
    ...
    st.toast("Please verify that your user matches your chatbot user.",
             icon="✅")
...
def wizard_form_body():
    ...
    ###### Step 1: Month ######
    if st.session_state[
            "current_step"] == 1 and not st.session_state.month_disabled:
    ...
    ###### Step 2: Age ######
    if st.session_state[
            "current_step"] == 2 and not st.session_state.age_disabled:
    ...
    ###### Step 3: Income ######
    if st.session_state[
            "current_step"] == 3 and not st.session_state.income_disabled:
    ...
    with form_footer_container.container():
        ...
        disable_next_button = (True if st.session_state["current_step"] == 12
                               or st.session_state.next_disabled else False)
...
def render_wizard_view():
    ...
    with st.expander("Fill your data for our credit model",
                     expanded=st.session_state.flag):
        wizard_form_header()
        wizard_form_body()
